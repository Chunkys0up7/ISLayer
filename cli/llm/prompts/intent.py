"""Stage 4: Intent specification generation prompts."""
...
CRITICAL: Intent specs describe OUTCOMES, not procedures. They say WHAT must be achieved,
not HOW. The capsule handles the HOW; the intent spec handles the WHAT.
...
def build_intent_body_prompt(node_context: dict, frontmatter: dict) -> str:
...
1. **Outcome Statement** — What must be achieved (2-3 sentences)
